      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div className="relative h-44 w-44  rounded-full flex items-center justify-center text-white font-bold text-2xl">
            ...
            <span className="dark:text-white text-neutral-500 z-20">{text}</span>
          </div>
        </div>
      </div>
    </div>
...
export function CardPattern({ mouseX, mouseY, randomString }: any) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0  bg-gradient-to-r from-green-400 to-blue-700 opacity-0  group-hover/card:opacity-100 backdrop-blur-xl transition duration-500"
        style={style}
      />
      <motion.div
